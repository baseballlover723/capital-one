def load
  ...
  c4 = Customer.create(id: 4, first_name: "Philip", last_name: "Ross", street_number: "52", street_name: "weaboo drive", city: "tokyo", state: "Japan", zip: "N/A")
  c5 = Customer.create(id: 5, first_name: "Andrew", last_name: "Ma", street_number: "52", street_name: "weaboo drive", city: "tokyo", state: "Japan", zip: "N/A")
  ...
  a5 = Account.create(id: 1112, account_type: "Savings", nickname: "Philip's Savings", rewards: 0.00, balance: 2430.00, customer: c4)
  a6 = Account.create(id: 1113, account_type: "Savings", nickname: "Andrew's Savings", rewards: 0.00, balance: 2430.00, customer: c5)
  ...
  p4 = Purchase.create(id: 14, purchase_type: "merchant", merchant: m1, account: a1, purchase_date: DateTime.iso8601("2016-01-15"),
                       amount: 253.31, status: "declinded", "medium": "balance", description: "Luke got black out drunk and spent all of his retierment fund on expensive clothes from Andrew silk shop")
  ...
  p8 = Purchase.create(id: 5588, purchase_type: "merchant", merchant: m4, account: a2, purchase_date: DateTime.iso8601("2015-04-30"),
  ...
  p14 = Purchase.create(id: 659, purchase_type: "merchant", merchant: m5, account: a2, purchase_date: DateTime.iso8601("2015-10-11"),
                        amount: 296.73, status: "completed", "medium": "balance", description: "Nathan stayed at a hotel for the night")
...
# Amazon
  ...
  10.times do
    generate_random_purchase a1
    generate_random_purchase a2
    generate_random_purchase a3
    generate_random_purchase a5
    generate_random_purchase a6
...
def generate_random_purchase(account)
  date = Faker::Time.backward(14)
  Purchase.create(purchase_type: "merchant", merchant: Merchant.all.sample, account: account, purchase_date: date,
